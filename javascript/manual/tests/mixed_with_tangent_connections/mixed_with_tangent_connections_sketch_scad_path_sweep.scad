...
module sweep_pattern(profile) {
    union() {
        ...
        path_sweep(profile, line_0);
            

        path_sweep(profile, line_1);
            

        path_sweep(profile, line_2);
            

        path_sweep(profile, line_3);
            

        path_sweep(profile, line_4);
            

        path_sweep(profile, line_5);
            

        path_sweep(profile, line_6);
            

        path_sweep(profile, line_7);
