...
arc0_point1 = [14.644661, 14.644661, 0];
arc0_point1_angle = 495.000000;  // angle pointing toward arc center
arc0_point2 = [0.000000, 50.000000, 0];
arc0_point2_angle = 630.000000;  // angle pointing toward arc center
arc1_point1 = [50.000000, -0.000000, 0];
arc1_point1_angle = 180.000000;  // angle pointing toward arc center
arc1_point2 = [-0.000000, 50.000000, 0];
arc1_point2_angle = 270.000000;  // angle pointing toward arc center
arc2_point1 = [50.000000, -0.000000, 0];
arc2_point1_angle = 180.000000;  // angle pointing toward arc center
arc2_point2 = [14.644661, 14.644661, 0];
arc2_point2_angle = 315.000000;  // angle pointing toward arc center
arc3_point1 = [-14.644661, 14.644661, 0];
arc3_point1_angle = 225.000000;  // angle pointing toward arc center
arc3_point2 = [-50.000000, 0.000000, 0];
arc3_point2_angle = 360.000000;  // angle pointing toward arc center
arc4_point1 = [0.000000, 50.000000, 0];
arc4_point1_angle = 270.000000;  // angle pointing toward arc center
arc4_point2 = [-14.644661, 14.644661, 0];
arc4_point2_angle = 405.000000;  // angle pointing toward arc center
arc5_point1 = [0.000000, 50.000000, 0];
arc5_point1_angle = 270.000000;  // angle pointing toward arc center
arc5_point2 = [-50.000000, 0.000000, 0];
arc5_point2_angle = 360.000000;  // angle pointing toward arc center
